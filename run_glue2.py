...
def main():
    ...
    train_time = 0
    best_metric_value = 0
    task_metric = task_metrics[data_args.task_name]
    ...
    for epoch in epochs:
        ...
        for step, batch in enumerate(
            ...
            if (cur_step % training_args.eval_steps == 0 or cur_step % steps_per_epoch == 0) and cur_step > 0:
                ...
                eval_metric_result = eval_metric[task_metric]
                if best_metric_value < eval_metric_result:
                    best_metric_value = eval_metric_result
