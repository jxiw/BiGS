...
def main():
    ...
    model = BiGSForSequenceClassification.from_pretrained(
        model_args.model_name_or_path,
        config=config,
        cache_dir=model_args.cache_dir,
    ...
    def preprocess_function(examples):
        ...
        if sentence2_key is not None:
            texts = [examples[sentence1_key][idx] + ' [CLS], ' + examples[sentence2_key][idx] for idx in range(len(examples[sentence1_key]))]
        else:
